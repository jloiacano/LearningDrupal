...
class __TwigTemplate_d49215849ff5ff6bf8eeb2887c1b4912 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 70
        $context["classes"] = ["comment", "js-comment", (((($tmp =  !        // line 73
($context["parent_comment"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("comment--level-1") : ("")), (((        // line 74
($context["status"] ?? null) != "published")) ? (("comment--" . ($context["status"] ?? null))) : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 75
($context["comment"] ?? null), "owner", [], "any", false, false, true, 75), "anonymous", [], "any", false, false, true, 75)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("by-anonymous") : ("")), (((        // line 76
